<template>
  <el-container style="overflow: hidden">
    <el-main class="main">
      <p style="line-height: 20px; justify-self: center; font-weight: bolder" class="glass-text">大箱线图</p>
      <div ref="boxplot" style="width: 830px; height: 550px;justify-self: center" class="glass-container"></div>
    </el-main>
