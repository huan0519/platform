<template>
  <el-container style="overflow: hidden">
    <el-main class="main">
      <p style="line-height: 10px;justify-self: center; font-weight: bolder" class="glass-text">堆叠柱状图</p>
      <div ref="stack_bar" style="justify-self: center" class="glass-container"></div>
    </el-main>
