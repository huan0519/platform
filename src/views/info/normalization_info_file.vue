<template>
  <div>
    ...
    <el-table :data="tableData" border stripe header-cell-class-name="headerbg"
      ...
      <el-table-column prop="data_total" label="数据总条数" width="130"></el-table-column>
      <el-table-column prop="data_type" label="数据类型" width="130"></el-table-column>
      <el-table-column prop="Yin_num" label="阴虚" width="130"></el-table-column>
      <el-table-column prop="Yang_num" label="阳虚" width="130"></el-table-column>
      <el-table-column prop="balance_num" label="平和" width="130"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    load () {
      axios.get('http://localhost:8000/normalized_file_info/paginate', {
        params: {
    ...
    save(){
      axios.post('http://localhost:8000/update/normalized_file_info', {
            id: this.form.id,
            data:this.form,
          }
      ).then(res => {
